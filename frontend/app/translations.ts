...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    // Video options
    videoOption: '비디오 옵션',
    refImageToVideo: '이미지 → 비디오',
    textOnlyToVideo: '텍스트 → 비디오',
    videoToVideo: '모션 컨트롤',
    ...
    portfolio: '포트폴리오',
    tabConfig: '설정',
    selectRefImage: '참고 이미지 선택',
    tapToSelectRefImage: '탭하여 참고 이미지 선택',
    referenceImageSelected: '참고 이미지 선택됨',
    optional: '선택',
    previousRefImages: '이전 참고 이미지',
    noRefImages: '이전 참고 이미지가 없습니다',
    tapToSelectFirstFrame: '탭하여 첫 프레임 선택',
    firstFrameSelected: '첫 프레임 선택됨',
    tapToSelectMotionImage: '탭하여 캐릭터 이미지 선택',
    motionImageSelected: '캐릭터 이미지 선택됨',
  ...
  en: {
    ...
    refImageToVideo: 'Image → Video',
    textOnlyToVideo: 'Text → Video',
    videoToVideo: 'Motion Control',
    ...
    tapToSelectRefImage: 'Tap to select reference image',
    referenceImageSelected: 'Reference image selected',
    optional: 'Optional',
    previousRefImages: 'Previous References',
    noRefImages: 'No previous reference images',
    tapToSelectFirstFrame: 'Tap to select first frame',
    firstFrameSelected: 'First frame selected',
    tapToSelectMotionImage: 'Tap to select character image',
    motionImageSelected: 'Character image selected',
